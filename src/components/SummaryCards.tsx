...
export const SummaryCards = memo(function SummaryCards({ days, taxiDays, taxiCost, taxiPendingCost, allPendingCost, totalCompTimeDays, periodLabel, onPendingClick, onCompTimeClick }: SummaryCardsProps) {
  const cards = [
